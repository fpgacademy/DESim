...
\begin{figure}[h]
	\begin{center}
        ...
        \fbox{\includegraphics[scale=0.60]{figures/GitHub_releases.png}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=.70]{figures/welcome.png}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=.70]{figures/install.png}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
            \setlength{\fboxsep}{0pt}
            \fbox{\includegraphics[width = .9\textwidth]{figures/DESim_open_local.png}}
	\end{center}
