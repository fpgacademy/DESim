...
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=12,lastline=12]{../../demos/addern/top.v}}
...
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=8]{../../demos/addern/addern.v}}
...
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=7]{../../demos/addern/top.v}}
...
described shortly. If the Verilog version of the {\it addern} project was opened, the second call 
to {\it vlog} compiles the source-code of the {\it addern} project, which includes the files 
{\it Addern.v} and {\it top.v}. If instead the VHDL version of the {\it Addern} project was opened,
the call to {\it vcom} compiles the source-code of the {\it Addern} project, which includes the files 
{\it Addern.vhd} and {\it top.vhd}. Any messages produced while executing the {\it run\_compile} script
are displayed inside the message pane in the {\it DESim} GUI, as illustrated in Figure~\ref{fig:compile}.
...
\begin{minipage}[h]{15 cm}
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=10]{../../demos/counter/Counter.v}}
...
\begin{minipage}[h]{15 cm}
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=7]{../../demos/counter/Top.v}}
...
\begin{minipage}[h]{15 cm}
\ifthenelse{\value{hdlNum}=0}
	{\lstinputlisting[language=Verilog,numbers=none,firstline=9]{../../demos/display/Display.v}}
