...
\begin{figure}[h]
	\begin{center}
        \setlength{\fboxsep}{0pt}
        \ifverilog{\fbox{\includegraphics[width = \textwidth]{figures/run_simulation.png}}}
        \else{\fbox{\includegraphics[width = \textwidth]{figures/run_simulation_vhdl.png}}}\fi
	\end{center}
...
\begin{minipage}[t]{15 cm}
	\ifverilog{\lstinputlisting[numbers=none]{../../demos/verilog/counter/Readme.txt}}
    \else{\lstinputlisting[numbers=none]{../../demos/vhdl/counter/Readme.txt}}\fi
\end{minipage}
