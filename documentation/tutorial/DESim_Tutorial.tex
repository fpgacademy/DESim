...
\newcommand{\doctitle}{Using the DESim Application \\ with Verilog Code}
\newcommand{\dochead}{Using the DESim Application with Verilog Code}

\newcommand{\pdftitle}{\dochead}
\newcommand{\FPGAcademyOrgTemplatePath}{../../../Common}

% This include all the settings that we should use for the document
\input{\FPGAcademyOrgTemplatePath/Docs/defaulttext.tex}
\input{\FPGAcademyOrgTemplatePath/Docs/preamble.tex}
...
\colorbox[rgb]{0,0.384,0.816}{\parbox[h]{\textwidth}{\color{white}\textsf{\textit{\FPGAcademyOrgTextBar}}}}
...
|\label{line:tb}|module tb();
    ...
    initial $sim_fpga(CLOCK_50, SW, KEY, LEDR, HEX, key_action, 
		scan_code, ps2_lock_control, VGA_X, VGA_Y, VGA_COLOR, 
		plot, GPIO);
    ...
    |\label{line:DUT}|top DUT (.CLOCK_50(CLOCK_50), .SW(SW), .LEDR(LEDR), .KEY(KEY),
...
\begin{minipage}[h]{17.5 cm}
\lstset{language=command.com,numbers=none,escapechar=|,moredelim=**[is][\color{Orange}]{@}{@}}
\begin{lstlisting}[]
@** Warning: (vlog-31) Unable to unlink file "C:/DESim/demos/addern/sim/work/_lock"@
\end{lstlisting}
\end{minipage}
...
\input{\FPGAcademyOrgTemplatePath/Docs/copyright.tex}
